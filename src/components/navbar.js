...
function Navbar(){
 ...
 <nav className="sticky top-0 z-50 bg-[#000814] px-4 py-3 shadow-md border-b-4 drop-shadow-lg">
  <div className="flex justify-between items-center">
    ...
    <button
      className="md:hidden text-2xl text-[#A7FC00]"
  ...
  {isopen && (
    <div className="absolute font-mono right-4 top-full mt-2 bg-[#000814] p-4 rounded-l-lg shadow-md flex flex-col space-y-3 text-right z-50 text-[#A7FC00] px-10">
